                ...
                if human_model.config.id2label[label.item()] == "person" and round(score.item(), 3) > 0.9:
                    ...
                    if len(bib_detections):
                        ...
                        for bib_box in bib_detections:
                            ...
                            if 999 < bib_number < 10000 and (
                                    str(bib_number).startswith("12") or str(bib_number).startswith("65") or
                                    str(bib_number).startswith("30") or str(bib_number).startswith("31") or str(
                                    bib_number).startswith("66")):
                                bib += 1
